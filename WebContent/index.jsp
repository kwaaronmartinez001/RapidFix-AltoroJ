	        ...
	        <%  try { %>
	                <%
	                 ...
	                 if(System.getProperty("os.name").toLowerCase().contains("windows"))
	                 {
	                	 shell = "cmd";
	                	 shellarg = "/c";
	                	 if (!Pattern.matches("[a-zA-Z0-9_\\-./\\\\]+", path) || !Pattern.matches("[a-zA-Z0-9_\\-.]+", content)) {
                              throw new IllegalArgumentException("Invalid path or content");
                         }
	                 ...
	                 Process proc = new ProcessBuilder(shell, shellarg, command).start();
	                 InputStream is = null;
	                 int exitVal = 0;
	                 try
	                 {
